...
public class CompareLiveAUwithPreprod {
	...
	public static Collection<Object[]> spreadsheetData() throws IOException {
		...
		return new SpreadSheetData(new FileInputStream(workingDir+"/src/test/resource/holdenAU_URLs.xls")).getData();
	}

	public CompareLiveAUwithPreprod(String urlList)	 {
		this.myURL =urlList ;
	...
	public static void Setup() {
		...
		driver = eyes.open(driver, "Applitools", "Holden AU Live Vs Preprod ",new RectangleSize(1024, 768));
	}
