...
public class CompareLiveAUwithUAT {
	...
	public CompareLiveAUwithUAT(String urlList)	 {
		this.myURL =urlList ;
	...
	public static void Setup() {
		...
		driver = eyes.open(driver, "Applitools", "Holden AU Live Vs UAT ",new RectangleSize(1850,1200));
	}
